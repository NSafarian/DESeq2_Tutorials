...
This is the first script of a series of R Markdown documents contaning codes for bulk brain tissue RNA-Seq analysis using DESeq2 package. In summary, what is presented in each script is as follows:
  - Script 1) The Common Mind data set is downloaded directly from Synpaser.
  - Script 2) Construct DESeq2 object and perform differential gene expression profiling.
  - Script 3) Data transformations and visualization.
